...
import MyPost from './components/ProfileScreens/Mypost';
import Planner from './components/ProfileScreens/Planner';
import Blog from './components/GeneralScreens/Blog'
const App = () => {
                  ...
                  <div className="App">
                        ...
                        <Routes>
                              <Route path="/" element={<LayoutsWithHeader />}>
                                    ...
                                    <Route exact path='/MyPost' element={<PrivateRoute />}>
